...
@section('content')
	...
	<div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title">สินค้า / สร้างสินค้า</h4> 
        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    ...
                                    <input type="text" onkeypress="return hasWhiteSpace()" name="product_id" class="form-control" required="">
                                </div>
                                <div class="col-md-5">
                                    <label>รหัส Barcode</label>
                                    <input type="text" onkeypress="return hasWhiteSpace()" name="product_barcode" class="form-control" required="">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-5">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select name="type_product_id" class="form-control select2" required="">
                                        ...
                                        @foreach($typeproducts as $typeproduct)
                                            <option value="{{$typeproduct->type_product_id}}">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select name="category_product_id" class="form-control select2" required="">
                                        ...
                                        @foreach($cateproducts as $cateproduct)
                                            <option value="{{$cateproduct->category_product_id}}">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select name="brand_product_id" class="form-control select2" required="">
                                        ...
                                        @foreach($brandproducts as $brandproduct)
                                            <option value="{{$brandproduct->brand_product_id}}">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <input step="any" type="number" name="product_price_cost" class="form-control" required="">
                                </div>
                                
                                <div class="col-md-4">
                                    <label>ราคาปกติ (บาท)</label>
                                    <input step="any" type="number" name="product_price_normal" class="form-control" required="">
                                </div>
                                <div class="col-md-4">
                                    <label>ราคาขาย (บาท)</label>
                                    <input step="any" type="number" name="product_price_sale" class="form-control" required="">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <div class="input-group">
                                      <input step="any" type="number" name="product_gp_hps" class="form-control" required="">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="input-group">
                                      <input step="any" type="number" name="product_gp_tnews" class="form-control" required="">
                                      <span class="input-group-addon">%</span>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    ...
                                    <div class="input-group">
                                      <input step="any" type="number" name="product_gp_supplier" class="form-control" required="">
                                      <span class="input-group-addon">%</span>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <label>อายุสินค้า (วัน)</label>
                                    <input type="number" name="product_age" class="form-control" required="">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <label>รายละเอียดสินค้า</label>
                                    <textarea name="product_detail_full" class="form-control" rows="5"></textarea>
                                </div>
                                
                                <div class="col-md-6">
                                    <label>รายละเอียดสินค้า (แบบย่อ)</label>
                                    <textarea name="product_detail_short" class="form-control" rows="5"></textarea>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-2">
                                    <label class="p-small">กว้าง (เซนติเมตร)</label>
                                    <input step="any" type="number" name="product_dimension_width" class="form-control">
                                </div>
                                
                                <div class="col-md-2">
                                    <label class="p-small">ยาว (เซนติเมตร)</label>
                                    <input step="any" type="number" name="product_dimension_length" class="form-control">
                                </div>
                                <div class="col-md-2">
                                    <label class="p-small">สูง (เซนติเมตร)</label>
                                    <input step="any" type="number" name="product_dimension_height" class="form-control">
                                </div>
                                <div class="col-md-3">
                                    <label class="p-small">น้ำหนักสินค้า (กิโลกรัม)</label>
                                    <input step="any" type="number" name="product_dimension_weight" class="form-control">
                                </div>
                                <div class="col-md-3">
                                    <label class="p-small">ปริมาณบรรจุภัณฑ์ (กรัม/กิโลกรัม)</label>
                                    <input step="any" type="number" name="product_dimension_pack_volume" class="form-control">
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <textarea name="product_note" class="form-control" rows="5"></textarea>
                                </div>
                            </div>
                            <div class="row">
        ...
        $("#choose-file").on('change', function(e){
            ...
            $.ajax({
                ...
                success: function(res){
                    $('.pre-loading').html('');
                    getShowPictureUpload(res.time);
                }
            });
        });

        function getShowPictureUpload(time){
            $.ajax({
