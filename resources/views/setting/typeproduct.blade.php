            ...
            <div class="white-box">
                ...
                <ul class="nav nav-tabs">
                    <li class="active" id="li-add">
                        <a  href="#form" id="a-add" data-toggle="tab">ฟอร์มประเภทสินค้า</a>
                    </li>
                    <li id="li-list">
                        <a href="#list" id="a-list" data-toggle="tab">รายการประเภทสินค้า</a>
                    </li>
                </ul>
                ...
                <div class="tab-content ">
                    <div class="tab-pane active" id="form">
                        ...
                        <form class="frm" id="frm">
                            ...
                            <input type="hidden" name="type_product_id" value="">
                            <div>
                                <label>ชื่อประเภทสินค้า</label>
                                <input type="text" name="type_product_name" required="" class="form-control">
                            </div>
                            <div>
                        ...
                        <table id="example" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="javascript:" data-name="{{$type->type_product_name}}" data-id="{{$type->type_product_id}}" class="btn btn-default btn-xs btn-edit">
                                            แก้ไข
                                        </a>
                                    </td>
                                </tr>
...
@section('scripts')
	...
	<script>
        ...
        $("#frm").submit(function(){
            ...
            $.ajax({
                url: "{{url('/setting/type-product/save')}}",
                data: $(this).serialize(),
                type: 'POST',
                dataType: 'json',
        ...
        $('.btn-edit').on('click', function(){
            ...
            $('input[name=type_product_name]').val(name);
            $('input[name=type_product_id]').val(id);
